...
It's goal is to just overview quickly what happened over the month and do a cleanup (finances, apps, etc.). A kind of cleanse to cut the waste going into the month. Should hopefully be fairly optimized processed with time for both week and month reviews.
