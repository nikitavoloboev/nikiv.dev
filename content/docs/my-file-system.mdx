...
```
alfred  browser  config  elixir  help    lean  moonbit    nix    odin  other  py       rust   snippets  ts  zig
base    c        deno    go      kotlin  mojo  nikiv.dev  ocaml  org   pause  raycast  scala  swift     ui
```
